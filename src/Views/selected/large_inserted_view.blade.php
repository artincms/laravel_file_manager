<div class="container-fluid">
    <ul class="media-content clearfix col-md-12">
        @foreach($data as $file_item)
            <li class="pull-left" id="{{$section}}_{{$file_item['file']['id']}}_trash_insert_li" style="list-style: none;width: 342px;padding: 1%;text-align: center;@if(app()->getLocale() == 'en') float: left ; @else float:right ; @endif">
