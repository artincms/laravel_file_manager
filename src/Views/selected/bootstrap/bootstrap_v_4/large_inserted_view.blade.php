            ...
            <li class="float-left" id="{{$section}}_{{$file_item['file']['id']}}_trash_insert_li" style="list-style: none;width: 342px;padding: 1%;text-align: center">
                <div class="pull-left" style="padding: 2%;box-shadow: 1px 1px #dedcdc;background-color: white;    margin: 1%;">
                    <div class="insert_thumb_action">
                        @if(!$show)
                            <a href="" target="_blank" class="pull-left" id="{{$section}}_trash_inserted" data-type="file" data-section="{{$section}}" data-file_id="{{$file_item['file']['id']}}">
                    ...
                    <div class="insert_thumb_info center">
                        <div class="user_detail row">
                            ...
                            <i aria-hidden="true" style="font-size: 14px;" class="fa fa-user col-md-6">
                                <span class="icon_info_image">{{$file_item['file']['user']}} </span>
                            </i>
                            <i  class="fa fa-calendar-o col-md-6" style="font-size: 14px;margin-top: 3%;"  aria-hidden="true" style="margin-top: 3%;">
