...
<div class="modal fade" id="create_edit_picture_modal" tabindex="-1" role="dialog" aria-labelledby="create_modal" aria-hidden="true">
    <div class="modal-dialog modal-lg modal_dialog_category" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title_edit_file_name">Edit picture</h5>
                <nav class="nav nav-pills nav-justified">
                    <a class="nav-link active" id="nva_orginal">Active</a>
                    <a class="nav-link" id="nva_large">Longer nav link</a>
                    <a class="nav-link" id="nva_medium">Link</a>
                    <a class="nav-link" id="nva_small">Disabled</a>
                </nav>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body modal_body_edit_picture">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="modal_iframe create_edit_picture_modal_iframe " id="modal_iframe_edit_file_name"></iframe>
                </div>
            </div>
