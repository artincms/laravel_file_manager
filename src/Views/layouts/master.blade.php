...
<head>
    ...
    <link href="{{ asset('vendor/laravel_file_manager/packages/jstree/dist/themes/default/style.min.css') }}" rel="stylesheet">
    @yield('add_css')
    {{--add js file--}}
    ...
    <script type="text/javascript" src="{{asset('vendor/laravel_file_manager/packages/jstree/dist/jstree.min.js')}}"></script>
